...
def test(dataset_name='multiviewx', pred=False):
    if dataset_name == 'multiviewx':
        ...
        result_fpath = "/mnt/2024-09-30_15-06-08-691207/test_2/test_0.25.txt"
        result_fpath = "/mnt/2024-10-04_14-40-01-332310/test_0/test_0.30.txt"
        result_fpath = "/mnt/2024-09-27_15-42-29-321121/test_1/test_0.35_uda.txt"
        result_fpath = "/mnt/2024-09-30_15-07-08-248721/test_0/test_0.30_uda.txt"
        ...
        # result_fpath = "/mnt/2024-10-04_14-39-55-650960/test_0/test_0.35.txt"
        # result_fpath = "/mnt/2024-10-04_14-39-57-721872/test_0/test_0.30.txt"
        # dataset = frameDataset(Wildtrack(os.path.expanduser('~/Data/Wildtrack')), False,
        #                        T.Compose([T.Resize([270, 480]), T.ToTensor(), ]))
        # dataset = frameDataset(Wildtrack('/data/Wildtrack', cameras=[2,4,5,6]), False, T.Compose([T.Resize([270, 480]), T.ToTensor(), ]))
